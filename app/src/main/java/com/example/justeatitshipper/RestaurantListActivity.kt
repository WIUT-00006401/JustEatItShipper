...
import com.example.justeatitshipper.Adapter.MyRestaurantAdapter
import com.example.justeatitshipper.Callback.IRestaurantCallbackListener
import com.example.justeatitshipper.Common.Common
import com.example.justeatitshipper.Model.EventBus.RestaurantSelectEvent
            ...
            .addListenerForSingleValueEvent(object :ValueEventListener{
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    if (p0.exists())
                    {
                        ...
                        {
                            dialog.dismiss()
                            Toast.makeText(this@RestaurantListActivity,"You must be allowed by Admin app",Toast.LENGTH_SHORT).show()
                        }
                    }
                    else
                    {
            ...
            .setPositiveButton("REGISTER", {_, _->
                ...
                serverRef!!.child(serverUserModel.uid!!)
                    ...
                    .addOnCompleteListener { _ ->
                        dialog!!.dismiss()
                        Toast.makeText(this@RestaurantListActivity, "Register success! Admin will check and active user soon",
